...
import copy
#from UB.utility import to_pickled_df, pad_history
import random
...
L = 5
is_valid = False
train_df = pd.read_csv(data_directory + 'UB_train.csv')
valid_df = pd.read_csv(data_directory + 'UB_valid.csv')

test_df = pd.read_csv(data_directory + 'UB_test.csv')

between_val_test_df = pd.read_csv(data_directory + 'UB_between_val_test.csv')
# print("################", valid_df, '\n', test_df, '\n', between_val_test_df)
...
pickle.dump(new_train, open('UB/train.txt', 'wb'))
pickle.dump(new_valid, open('UB/test.txt', 'wb'))
